...
(function() {
    ...
    root.define([], function() {
        describe('In joystick_global_variable', function() {
            it('generates expected default Arduino code', function() {
                expect(true).to.equal(true);
                Blockly.mainWorkspace.clear();
                Blockly.Xml.domToWorkspace(Blockly.mainWorkspace, Blockly.Xml.textToDom(loadXMLDoc("test/res/joystick_global_variable.xml")));
