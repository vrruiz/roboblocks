...
(function() {
    var language = {
        ...
        LANG_ADVANCED_INOUT_ANALOG_WRITE: 'Escribir en PIN analógico',
        ...
        LANG_ADVANCED_MATH_RANDOM_SEED: 'Iniciar generador de aleatorios a partir de',
        LANG_ADVANCED_MATH_RANDOM_SEED_TOOLTIP: 'Inicializa el generador de números aleatorios. Para que no empiece siempre por la misma secuencia de números aleatorios, es recomendable poner la lectura de un pin analógico que no esté conectado.',
        //procedures blocks
