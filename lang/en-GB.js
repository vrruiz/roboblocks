...
(function() {
    var language = {
        ...
        LANG_CATEGORY_STEPPER: 'Stepper motors',
        LANG_STEPPER_DEF: 'Stepper motor',
        LANG_STEPPER_DEF_STEPS: 'Steps per revolution',
        ...
        LANG_STEPPER_DEF_TOOLTIP: 'Module definition to control a stepper motor.',
        LANG_STEPPER_SETSPEED: 'Set speed to',
        LANG_STEPPER_SETSPEED_NEXT: '(rpm)',
        LANG_STEPPER_SETSPEED_TOOLTIP: 'Set motor rotation speed in rpm.',
        LANG_STEPPER_STEP: 'Move motor',
        LANG_STEPPER_STEP_NEXT: '(steps)',
        LANG_STEPPER_STEP_TOOLTIP: 'Moves motor the number of steps. A positive value moves in one direction, a negative value to the other direction.'
    };
    // Node
