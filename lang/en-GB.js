...
(function() {
    var language = {
        ...
        LANG_ADVANCED_MATH_RANDOM_SEED: 'Initialize random generator from',
        LANG_ADVANCED_MATH_RANDOM_SEED_TOOLTIP: 'Initializes random number generator. This prevents the random number generator to give the same random secuence. Recommenden to read the value from an unused analog pin using analogRead.',
        //procedures blocks
