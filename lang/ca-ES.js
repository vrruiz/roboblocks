...
(function() {
    var language = {
        ...
        LANG_CONTROLS_DOWHILE_TOOLTIP: 'Mentre la condició es compleix, continua executant les accions.',
        LANG_CONTROLS_EXECUTE: 'Executa',
        ...
        LANG_CONTROLS_IF_TOOLTIP_1: 'Si la condició es compleix, executa les accions dins del bloc.',
        LANG_CONTROLS_IF_TOOLTIP_2: 'Si la condició es compleix, s\'executa el primer bloc d\'ordres. Si no, s\'executa el segon bloc d\'ordres.',
        LANG_CONTROLS_IF_TOOLTIP_3: 'Si el primer valor es compleix, s\'executa el primer bloc d\'ordres. Si no, si el segon valor es compleix, s\'executa el segon bloc d\'ordres.',
        LANG_CONTROLS_IF_TOOLTIP_4: 'Si el primer valor es compleix, s\'executa el primer bloc d\'ordres. Si no, si el segon valor es compleix, s\'executa el segon bloc d\'ordres. Si cap dels valors es compleix, s\'executa l\'últim bloc d\'ordres',
        LANG_CONTROLS_IF_MSG_IF: 'si',
        LANG_CONTROLS_IF_MSG_ELSEIF: 'en canvi, si',
        LANG_CONTROLS_IF_MSG_ELSE: 'en cas contrari',
        LANG_CONTROLS_IF_MSG_THEN: 'executa',
        ...
        LANG_CONTROLS_FOR_INPUT_DO: 'executa',
        ...
        LANG_CONTROLS_WHILEUNTIL_TOOLTIP_WHILE: 'Mentre la condició es compleixi, executa les instruccions.',
        LANG_CONTROLS_WHILEUNTIL_TOOLTIP_UNTIL: 'Mentre la condició no es compleixi, executa les instruccions.',
        LANG_CONTROLS_REPEAT_TITLE_REPEAT: 'Repeteix',
        LANG_CONTROLS_REPEAT_TITLE_TIMES: 'vegades',
        LANG_CONTROLS_REPEAT_INPUT_DO: 'executa',
        ...
        LANG_CONTROLS_SETUP_LOOP_TOOLTIP: 'Els blocs dins de «setup» s\'executen a l\'inici, i els blocs dins de «loop» es repetiran contínuament.',
        ...
        LANG_CONTROLS_SWITCH_DEFAULT_TOOLTIP: 'El bloc «default» especifica l\'acció que s\'executarà si no s\'ha complert cap dels casos anteriors.',
        ...
        LANG_CONTROLS_SWITCH_DO: 'executa',
        //math blocks :
        ...
        LANG_PROCEDURES_DEFNORETURN_DO: 'executa',
        ...
        LANG_PROCEDURES_DEFRETURN_DO: 'executa',
        ...
        LANG_PROCEDURES_CALLNORETURN_CALL: 'executa',
        ...
        LANG_PROCEDURES_CALLRETURN_CALL: 'executa',
