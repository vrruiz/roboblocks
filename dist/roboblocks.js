    ...
    var load = function(options) {
        ...
        (function() {
            var language = {
                //random :
                BLOCKLY_MSG_DUPLICATE_BLOCK: 'Duplicar',
                BLOCKLY_MSG_REMOVE_COMMENT: 'Remover coment�rio',
                BLOCKLY_MSG_ADD_COMMENT: 'Adicionar coment�rio',
                ...
                LANG_VARIABLES_SET_ITEM: 'elemento',
                LANG_RESERVED_WORDS: 'Palavra reservada: este nome n�o � permitido.',
                //logic blocks:
                LANG_CATEGORY_LOGIC: 'L�gica',
                LANG_LOGIC_OPERATION_AND: 'e',
                LANG_LOGIC_OPERATION_OR: 'ou',
                LANG_LOGIC_COMPARE_TOOLTIP_EQ: 'Compara se as duas entradas s�o iguais.',
                LANG_LOGIC_COMPARE_TOOLTIP_NEQ: 'Compara se as duas entradas n�o s�o iguais entre s�.',
                LANG_LOGIC_COMPARE_TOOLTIP_LT: 'Compara se a primera entrada � menor do que a segunda entrada.',
                LANG_LOGIC_COMPARE_TOOLTIP_LTE: 'Compara se a primera entrada � menor ou igual � segunda entrada.',
                LANG_LOGIC_COMPARE_TOOLTIP_GT: 'Compara se a primera entrada � maior do que a segunda entrada.',
                LANG_LOGIC_COMPARE_TOOLTIP_GTE: 'Compara se a primera entrada � maior ou igual � segunda entrada.',
                LANG_LOGIC_OPERATION_TOOLTIP_AND: 'Compara se ambas as entradas s�o verdadeiras.',
                LANG_LOGIC_OPERATION_TOOLTIP_OR: 'Compara se alguma das entradas � verdadeira.',
                LANG_LOGIC_NEGATE_INPUT_NOT: 'n�o',
                LANG_LOGIC_NEGATE_TOOLTIP: 'Devolve o inverso da entrada.',
                LANG_LOGIC_NEGATE_HELPURL: '',
                LANG_LOGIC_BOOLEAN_TRUE: 'verdadeiro',
                LANG_LOGIC_BOOLEAN_FALSE: 'falso',
                LANG_LOGIC_BOOLEAN_TOOLTIP: 'Devolve verdadeiro ou falso em fun��o do seleccionado.',
                //communication blocks:
                LANG_CATEGORY_COMMUNICATION: 'Comunica��o',
                LANG_BQ_BLUETOOTH_RECEIVE: 'Bluetooth: receber ',
                LANG_BQ_BLUETOOTH_RECEIVE_BLUETOOTH: 'Bluetooth',
                LANG_BQ_BLUETOOTH_RECEIVE_TOOLTIP: 'Devolve os dados recebidos pelo m�dulo Bluetooth',
                LANG_BQ_BLUETOOTH_SEND: 'Bluetooth: Enviar',
                LANG_BQ_BLUETOOTH_SEND_SEND: 'Enviar dados',
                LANG_BQ_BLUETOOTH_SEND_TOOLTIP: 'Os dados da entrada s�o enviados usando o m�dulo Bluetooth',
                LANG_BQ_BLUETOOTH_DEF: 'Bluetooth',
                LANG_BQ_BLUETOOTH_DEF_BAUD_RATE: 'Baud Rate',
                LANG_BQ_BLUETOOTH_DEF_PIN1: 'RX',
                LANG_BQ_BLUETOOTH_DEF_PIN2: 'TX',
                LANG_BQ_BLUETOOTH_DEF_NAME: 'Nome',
                LANG_BQ_BLUETOOTH_DEF_PINCODE: 'C�digo PIN',
                LANG_BQ_BLUETOOTH_DEF_RECEIVE: 'Receber',
                LANG_BQ_BLUETOOTH_DEF_SEND: 'Enviar',
                LANG_BQ_BLUETOOTH_DEF_TOOLTIP: 'Definic�o do m�dulo Bluetooth',
                LANG_ADVANCED_BT_SERIAL_AVAILABLE: 'Bluetooth: Porta S�rie dispon�vel',
                LANG_ADVANCED_BT_SERIAL_AVAILABLE_TOOLTIP: 'Verifica se o m�dulo Bluetooth est� dispon�vel ou n�o',
                LANG_ADVANCED_SERIAL_AVAILABLE: 'Porta S�rie dispon�vel',
                LANG_ADVANCED_SERIAL_AVAILABLE_TOOLTIP: 'Verifica se a porta s�rie est� dispon�vel ou n�o',
                LANG_ADVANCED_SERIAL_PRINT: 'Imprimir pela porta s�rie',
                LANG_ADVANCED_SERIAL_PRINT_TOOLTIP: 'Imprime os dados como texto ASCII.',
                LANG_ADVANCED_SERIAL_PRINTLN: 'Imprimir pela porta s�rie com salto de linha',
                LANG_ADVANCED_SERIAL_PRINTLN_TOOLTIP: 'Imprime os dados como texto ASCII e con retorno de carro (RC).',
                LANG_ADVANCED_SERIAL_READ: 'Ler a porta s�rie',
                LANG_ADVANCED_SERIAL_READ_TOOLTIP: 'L� os dados recebidos pela porta s�rie como bytes.',
                LANG_ADVANCED_SERIAL_READSTRING: 'Ler seq��ncia a porta s�rie',
                LANG_ADVANCED_SERIAL_READSTRING_TOOLTIP: 'L� os dados recebidos pela porta s�rie como texto ASCII.',
                ...
                LANG_BQ_BAT_RED_PIN: 'ECHO PIN#',
                LANG_BQ_BAT_BLUE_PIN: 'TRIGGER PIN#',
                LANG_BQ_BAT_TOOLTIP: 'Devolve a dist�ncia medida pelo sensor.',
                LANG_BQ_BUTTON: 'Bot�o',
                LANG_BQ_BUTTON_PIN: 'PIN#',
                LANG_BQ_BUTTON_TOOLTIP: 'Bot�o',
                LANG_BQ_BUTTONS: 'Botoneira',
                LANG_BQ_BUTTONS_PIN: 'PIN#',
                LANG_BQ_BUTTONS_BUTTON_A: 'Bot�o #A',
                LANG_BQ_BUTTONS_BUTTON_B: 'Bot�o #B',
                LANG_BQ_BUTTONS_BUTTON_C: 'Bot�o #C',
                LANG_BQ_BUTTONS_BUTTON_D: 'Bot�o #D',
                LANG_BQ_BUTTONS_BUTTON_E: 'Bot�o #E',
                ...
                LANG_BQ_JOYSTICK_POSITION: 'Posi��o Joystick',
                LANG_BQ_JOYSTICK_PIN_BUTTON: 'Bot�o PIN#',
                LANG_BQ_JOYSTICK_TOOLTIP: 'Joystick',
                LANG_BQ_LED: 'LED',
                LANG_BQ_LED_PIN: 'PIN#',
                LANG_BQ_LED_STATE: '',
                ...
                LANG_BQ_PHOTORESISTOR: 'Sensor de Luz',
                LANG_BQ_PHOTORESISTOR_PIN: 'PIN#',
                LANG_BQ_PHOTORESISTOR_TOOLTIP: 'Devolve o valor anal�gico medido pela foto-resist�ncia.',
                LANG_BQ_PIEZO_BUZZER: 'Cigarra',
                LANG_BQ_PIEZO_BUZZER_PIN: 'PIN#',
                LANG_BQ_PIEZO_BUZZER_TONE: 'TOM',
                LANG_BQ_PIEZO_BUZZER_DO: 'DO',
                LANG_BQ_PIEZO_BUZZER_RE: 'R�',
                LANG_BQ_PIEZO_BUZZER_MI: 'MI',
                LANG_BQ_PIEZO_BUZZER_FA: 'FA',
                LANG_BQ_PIEZO_BUZZER_SOL: 'SOL',
                LANG_BQ_PIEZO_BUZZER_LA: 'LA',
                LANG_BQ_PIEZO_BUZZER_SI: 'SI',
                LANG_BQ_PIEZO_BUZZER_DURATION: 'Dura��o',
                LANG_BQ_PIEZO_BUZZER_TOOLTIP: 'Cigarra - Elemento piezoel�ctrico',
                LANG_BQ_PIEZO_BUZZERAV: 'Cigarra avan�ado',
                LANG_BQ_PIEZO_BUZZERAV_PIN: 'PIN#',
                LANG_BQ_PIEZO_BUZZERAV_TONE: 'TOM',
                LANG_BQ_PIEZO_BUZZERAV_DURATION: 'Dura��o',
                LANG_BQ_PIEZO_BUZZERAV_TOOLTIP: 'Cigarra avan�ado',
                LANG_BQ_POTENTIOMETER: 'Potenci�metro',
                LANG_BQ_POTENTIOMETER_PIN: 'PIN#',
                LANG_BQ_POTENTIOMETER_TOOLTIP: 'Devolve o valor anal�gico medido pelo Potenci�metro',
                //LCD blocks:
                LANG_CATEGORY_LCD: 'LCD bloqs',
                LANG_LCD_DEF: 'LCD (2x16)',
                LANG_LCD_PINS: 'Conecta o pino SCL ao pino A5 e o pino SDA ao pino A4',
                LANG_LCD_DEF_TOOLTIP: 'Define o LCD',
                LANG_LCD_ADVANCED_DEF: 'LCD avan�ado',
                LANG_LCD_ADVANCED_ROWS: 'Linhas',
                LANG_LCD_ADVANCED_COLUMNS: 'Colunas',
                LANG_LCD_DEF_ADVANCED_TOOLTIP: 'Bloco que define o LCD avan�ado',
                LANG_LCD_SETBACKLIGHT: 'LCD: ajustar a retroilumina��o',
                LANG_LCD_SETBACKLIGHT_CLOSE: '',
                LANG_LCD_SETBACKLIGHT_TOOLTIP: 'Ajusta a retroilumina��o do LCD',
                LANG_LCD_PRINT: 'LCD: Imprimir ',
                LANG_LCD_PRINT_POSITION: 'Definir a posi��o do texto?',
                LANG_LCD_PRINT_TOOLTIP: 'Imprime uma frase no LCD na posi��o espec�ficada ou na seguinte dispon�vel.',
                ...
                LANG_CONTROLS_IF_TOOLTIP_1: 'Se a condi��o � verdadeira, executa as a��es dentro do bloco.',
                LANG_CONTROLS_IF_TOOLTIP_2: 'Se a condi��o � verdadeira, executa o primero bloco de comandos. Se n�o �, executa o segundo bloco de comandos.',
                LANG_CONTROLS_IF_TOOLTIP_3: 'Se o primeiro valor � verdadeiro, executa o primero bloco de comandos. Sen�o, se o segundo valor � verdadeiro, executa o segundo bloco de comandos.',
                LANG_CONTROLS_IF_TOOLTIP_4: 'Se o primeiro valor � verdadeiro, executa o primero bloco de comandos. Sen�o, se o segundo valor � verdadeiro, executa o segundo bloco de comandos. Se nenhum dos valores � verdadeiro, executa o �ltimo bloco de comandos',
                LANG_CONTROLS_IF_MSG_IF: 'se',
                LANG_CONTROLS_IF_MSG_ELSEIF: 'sen�o, se',
                LANG_CONTROLS_IF_MSG_ELSE: 'sen�o',
                LANG_CONTROLS_IF_MSG_THEN: 'executar',
                LANG_CONTROLS_IF_IF_Field_IF: 'se',
                LANG_CONTROLS_IF_IF_TOOLTIP: 'Adicionar, eliminar ou reordenar se��es para reconfigurar este bloco "se".',
                LANG_CONTROLS_IF_ELSEIF_Field_ELSEIF: 'sen�o, se',
                LANG_CONTROLS_IF_ELSEIF_TOOLTIP: 'Adiciona uma condi��o ao bloco "se".',
                LANG_CONTROLS_IF_ELSE_Field_ELSE: 'sen�o',
                LANG_CONTROLS_IF_ELSE_TOOLTIP: 'Adiciona uma condi��o final ao bloco "se" para capturar o resto das op��es.',
                LANG_CONTROLS_FOR_FROM_WARNING: 'N�o � poss�vel definir uma vari�vel como o valor inicial do bloco.',
                LANG_CONTROLS_FOR_TO_WARNING: 'N�o � poss�vel definir uma vari�vel como o valor inicial do bloco.',
                LANG_CONTROLS_FOR_INPUT_WITH: 'Contar com',
                LANG_CONTROLS_FOR_INPUT_VAR: 'x',
                LANG_CONTROLS_FOR_INPUT_FROM: 'desde',
                LANG_CONTROLS_FOR_INPUT_TO: 'at�',
                LANG_CONTROLS_FOR_INPUT_DO: 'executar',
                LANG_CONTROLS_FOR_TOOLTIP: 'Contar desde de in�cio at� ao final. Cada vez que se incrementa o valor, a vari�vel fica com esse valor e s�o executadas as a��es.',
                LANG_CONTROLS_WHILEUNTIL_OPERATOR_WHILE: 'enquanto',
                LANG_CONTROLS_WHILEUNTIL_OPERATOR_UNTIL: 'at�',
                LANG_CONTROLS_WHILEUNTIL_TOOLTIP_WHILE: 'Enquanto a condi��o for verdadeira, executar as instru��es.',
                LANG_CONTROLS_WHILEUNTIL_TOOLTIP_UNTIL: 'Enquanto a condi��o for falsa, executar as instru��es.',
                LANG_CONTROLS_REPEAT_TITLE_REPEAT: 'Repetir',
                LANG_CONTROLS_REPEAT_TITLE_TIMES: 'vezes',
                LANG_CONTROLS_REPEAT_INPUT_DO: 'executar',
                LANG_CONTROLS_REPEAT_TOOLTIP: 'executar as instru��es um determinado n�mero de vezes.',
                LANG_CONTROLS_FLOW_STATEMENTS_HELPURL: '',
                LANG_CONTROLS_FLOW_STATEMENTS_INPUT_OFLOOP: '"loop"',
                LANG_CONTROLS_FLOW_STATEMENTS_OPERATOR_BREAK: 'interromper',
                LANG_CONTROLS_FLOW_STATEMENTS_OPERATOR_CONTINUE: 'seguir para o pr�ximo valor do "loop"',
                LANG_CONTROLS_FLOW_STATEMENTS_TOOLTIP_BREAK: 'Sair do "loop" nesta instru��o.',
                LANG_CONTROLS_FLOW_STATEMENTS_TOOLTIP_CONTINUE: 'Saltar o resto das a��es desta volta e continuar com para a pr�xima volta.',
                LANG_CONTROLS_FLOW_STATEMENTS_WARNING: 'Aten��o: Este bloco s� pode ser usado dentro de um "loop".',
                LANG_CONTROLS_SWITCH: 'se ',
                LANG_CONTROLS_SWITCH_TOOLTIP_1: 'executa as a��es se for este o caso.',
                LANG_CONTROLS_SWITCH_TOOLTIP_2: 'executa as a��es se for este o caso.',
                LANG_CONTROLS_SWITCH_TOOLTIP_3: 'executa as a��es se for este o caso.',
                LANG_CONTROLS_SWITCH_TOOLTIP_4: 'executa as a��es se for este o caso.',
                LANG_CONTROLS_SWITCH_SWITCH_TOOLTIP: 'Este bloco compara um a um se s�o cumpridos os diferentes casos.',
                LANG_CONTROLS_SWITCH_CASE_TOOLTIP: 'caso ',
                LANG_CONTROLS_SWITCH_DEFAULT_TOOLTIP: 'O bloco "default" especifica a a��o que se vai executar se n�o forem cumpridos nehum dos casos anteriores.',
                LANG_CONTROLS_SWITCH_IS: '�: ',
                LANG_CONTROLS_SWITCH_CASE: 'caso ',
                LANG_CONTROLS_SWITCH_COLON: ': ',
                LANG_CONTROLS_SWITCH_DEFAULT: 'noutro caso',
                LANG_CONTROLS_SWITCH_DO: 'executar',
                //math blocks :
                LANG_CATEGORY_MATH: 'Matem�ticas',
                LANG_MATH_ADVANCED_MAP_MAP: 'Mapear ',
                LANG_MATH_ADVANCED_MAP_FROM: 'De [',
                LANG_MATH_ADVANCED_MAP_HYPHEN: '-',
                LANG_MATH_ADVANCED_MAP_BRACKET: ']',
                ...
                LANG_MATH_NUMBER_TOOLTIP: 'N�mero inteiro',
                LANG_MATH_ARRAY_ARRAY3: '[3]',
                LANG_MATH_ARRAY_BRACKET3: '{',
                LANG_MATH_ARRAY_BRACKET4: '}',
                LANG_MATH_ARRAY_COMMA: ',',
                LANG_MATH_ARRAY_TOOLTIP: 'Vector de tr�s inteiros',
                LANG_ARRAY_GET_BRACKET1: '[',
                LANG_ARRAY_GET_BRACKET2: ']',
                LANG_ARRAY_GET_TOOLTIP: 'Devolve o valor de um elemento determinado do vetor.',
                LANG_MATH_MODULO_TOOLTIP: 'Devolve o resto da divis�o entre os valores das entradas.',
                LANG_MATH_BASE_MAP: 'Mapear ',
                LANG_MATH_BASE_MAP_VALUE_TO: 'Valor entre [0-',
                LANG_MATH_BASE_MAP_BRACKET: ']',
                LANG_MATH_BASE_MAP_TOOLTIP: 'Mapeia o intervalo de valores da entrada [0-1023] a outro intervalo de valores.',
                LANG_MATH_SINGLE_OP_ROOT: 'ra�z quadrada',
                LANG_MATH_SINGLE_OP_ABSOLUTE: 'valor absoluto',
                LANG_MATH_SINGLE_TOOLTIP_ROOT: 'Devolve a ra�z quadrada de um n�mero.',
                LANG_MATH_SINGLE_TOOLTIP_ABS: 'Devolve o valor absoluto de um n�mero.',
                LANG_MATH_SINGLE_TOOLTIP_NEG: 'Devolve a nega��o do sinal de um n�mero.',
                LANG_MATH_SINGLE_TOOLTIP_LN: 'Devolve o logaritmo de um n�mero.',
                LANG_MATH_SINGLE_TOOLTIP_LOG10: 'Devolve o logaritmo de base 10 de um n�mero.',
                LANG_MATH_SINGLE_TOOLTIP_EXP: 'Devolve o exponencial de um n�mero.',
                LANG_MATH_SINGLE_TOOLTIP_POW10: 'Devolve 10 elevado a uma pot�ncia.',
                //text blocks:
                LANG_CATEGORY_TEXT: 'Texto',
                LANG_TEXT_TEXT_HELPURL: '',
                ...
                LANG_TEXT_JOIN_TOOLTIP: 'Cria texto juntando qualquer n�mero de elementos.',
                LANG_TEXT_CREATE_JOIN_Field_JOIN: 'unir',
                LANG_TEXT_CREATE_JOIN_TOOLTIP: 'Adicionar, eliminar ou reordenar se��es para reconfigurar este bloco de texto.',
                LANG_TEXT_CREATE_JOIN_ITEM_Field_ITEM: 'elemento',
                ...
                LANG_TEXT_APPEND_VARIABLE: 'elemento',
                LANG_TEXT_APPEND_TOOLTIP: 'Adicionar texto a vari�vel e %1.',
                LANG_TEXT_LENGTH_HELPURL: '',
                LANG_TEXT_LENGTH_INPUT_LENGTH: 'longitude',
                LANG_TEXT_LENGTH_TOOLTIP: 'Devolve o n�mero de letras (incluindo os espa�os) no texto introduzido.',
                LANG_TEXT_EQUALSIGNORECASE_IS: '',
                LANG_TEXT_EQUALSIGNORECASE_EQUAL: ' =',
                LANG_TEXT_EQUALSIGNORECASE_QUESTION: '',
                LANG_TEXT_EQUALSIGNORECASE_TOOLTIP: 'Compara se os dois textos introduzidos s�o iguais, independentemente de que tenham letras mai�sculas ou min�sculas.',
                LANG_TEXT_SUBSTRING: 'Recortar ',
                LANG_TEXT_SUBSTRING_FROM: 'de',
                LANG_TEXT_SUBSTRING_TO: 'at�',
                LANG_TEXT_SUBSTRING_TOOLTIP: 'Recorta os caracteres do texto introduzido que se encontrem entre os dois �ndices e cria com eles um novo texto.',
                //advanced blocks :
                LANG_CATEGORY_ADVANCED: 'Fun��es PIN',
                LANG_ADVANCED_CONVERSION_CONVERT: 'Converter',
                LANG_ADVANCED_CONVERSION_DECIMAL: 'Decimal',
                LANG_ADVANCED_CONVERSION_HEXADECIMAL: 'Hexadecimal',
                LANG_ADVANCED_CONVERSION_OCTAL: 'Octal',
                LANG_ADVANCED_CONVERSION_BINARY: 'Bin�rio',
                LANG_ADVANCED_CONVERSION_VALUE: 'valor',
                LANG_ADVANCED_CONVERSION_TOOLTIP: 'Converter a base de um n�mero.',
                LANG_ADVANCED_INOUT_ANALOG_READ: 'Ler o pino anal�gico PIN#',
                LANG_ADVANCED_INOUT_ANALOG_READ_TOOLTIP: 'L� o valor de um pino anal�gico espec�fico.',
                LANG_ADVANCED_INOUT_ANALOG_WRITE: 'Escrever no pino anal�gico PIN#',
                LANG_ADVANCED_INOUT_ANALOG_WRITE_VALUE: 'valor',
                LANG_ADVANCED_INOUT_ANALOG_WRITE_TOOLTIP: 'Escreve um valor entre 0 e 255 num pino anal�gico espec�fico.',
                LANG_ADVANCED_BUILTIN_LED: 'LED DA PLACA',
                LANG_ADVANCED_BUILTIN_LED_STATE: 'Estado',
                LANG_ADVANCED_BUILTIN_LED_ON: 'ACESO',
                LANG_ADVANCED_BUILTIN_LED_OFF: 'APAGADO',
                LANG_ADVANCED_BUILTIN_LED_TOOLTIP: 'LED integrado na placa e que est� internamente conectado ao pino 13.',
                LANG_ADVANCED_INOUT_DIGITAL_READ: 'Ler o pino digital PIN#',
                LANG_ADVANCED_INOUT_DIGITAL_READ_TOOLTIP: 'L� o valor de um pino digital espec�fico.',
                LANG_ADVANCED_INOUT_DIGITAL_WRITE: 'Escrever no pino digital',
                LANG_ADVANCED_INOUT_DIGITAL_WRITE_PIN: 'PIN#',
                LANG_ADVANCED_INOUT_DIGITAL_WRITE_STATE: 'Estado',
                LANG_ADVANCED_INOUT_DIGITAL_WRITE_HIGH: 'ALTO',
                LANG_ADVANCED_INOUT_DIGITAL_WRITE_LOW: 'BAIXO',
                LANG_ADVANCED_INOUT_DIGITAL_WRITE_TOOLTIP: 'Escreve um valor num pino digital espec�fico.',
                LANG_ADVANCED_HIGHLOW_HIGH: 'ALTO',
                LANG_ADVANCED_HIGHLOW_LOW: 'BAIXO',
                LANG_ADVANCED_HIGHLOW_TOOLTIP: 'Escreve "ALTO" ou "BAIXO" em fun��o do selecionado.',
                LANG_ADVANCED_MATH_RANDOM: 'Aleat�rio entre',
                LANG_ADVANCED_MATH_RANDOM_AND: ' e ',
                LANG_ADVANCED_MATH_RANDOM_TOOLTIP: 'Cria um n�mero aleat�rio entre os dois limites introduzidos.',
                //procedures blocks
                LANG_CATEGORY_PROCEDURES: 'Fun��es',
                LANG_PROCEDURES_RETURN: 'devolver',
                LANG_PROCEDURES_RETURN_TOOLTIP: 'Devolve um valor',
                LANG_PROCEDURES_CALL_WITHOUT_DEFINITION: 'Chamada de uma fun��o n�o definida.',
                LANG_PROCEDURES_DEFNORETURN_HELPURL: '',
                LANG_PROCEDURES_DEFNORETURN_PROCEDURE: 'fun��o sem retorno',
                LANG_PROCEDURES_DEFNORETURN_DO: 'executar',
                LANG_PROCEDURES_DEFNORETURN_TOOLTIP: 'fun��o que se executa sem devolver nada.',
                LANG_PROCEDURES_DEFRETURN_HELPURL: '',
                LANG_PROCEDURES_DEFRETURN_PROCEDURE: 'fun��o com retorno',
                LANG_PROCEDURES_DEFRETURN_DO: 'executar',
                LANG_PROCEDURES_DEFRETURN_RETURN: 'Devolve',
                LANG_PROCEDURES_DEFRETURN_TOOLTIP: 'fun��o com valor de retorno.',
                LANG_PROCEDURES_DEF_DUPLICATE_WARNING: 'Aten��o: Esta fun��o tem par�metros duplicados.',
                LANG_PROCEDURES_CALLNORETURN_HELPURL: '',
                LANG_PROCEDURES_CALLNORETURN_CALL: 'executar',
                LANG_PROCEDURES_CALLNORETURN_PROCEDURE: ' fun��o sem retorno',
                LANG_PROCEDURES_CALLNORETURN_TOOLTIP: 'executa esta fun��o.',
                LANG_PROCEDURES_CALLRETURN_HELPURL: '',
                LANG_PROCEDURES_CALLRETURN_CALL: 'executar',
                LANG_PROCEDURES_CALLRETURN_PROCEDURE: ' fun��o com retorno',
                LANG_PROCEDURES_CALLRETURN_TOOLTIP: 'executa esta fun��o que tem valor de retorno.',
                LANG_PROCEDURES_MUTATORCONTAINER_Field: 'par�metros',
                LANG_PROCEDURES_MUTATORARG_Field: 'vari�vel:',
                LANG_PROCEDURES_HIGHLIGHT_DEF: 'Destaca a fun��o',
                LANG_PROCEDURES_IFRETURN_TOOLTIP: 'Se a condi��o � verdadeira, a fun��o devolver� este valor.',
                LANG_PROCEDURES_IFRETURN_WARNING: 'Aten��o: Este bloco s� pode ser usado dentro de uma fun��o que tenha valor de retorno.',
                //variables blocks :
                LANG_CATEGORY_VARIABLES: 'Vari�veis',
                LANG_VARIABLES_CALL_WITHOUT_DEFINITION: 'Esta vari�vel n�o est� declarada.',
                LANG_VARIABLES_GLOBAL: 'Vari�vel',
                LANG_VARIABLES_GLOBAL_TYPE: 'do tipo ',
                LANG_VARIABLES_GLOBAL_EQUALS: '=',
                LANG_VARIABLES_GLOBAL_TOOLTIP: 'Declara e define uma vari�vel GLOBAL do tipo inteiro (int) ou texto (String).',
                LANG_VARIABLES_LOCAL: 'Vari�vel LOCAL',
                LANG_VARIABLES_LOCAL_TYPE: 'do tipo ',
                LANG_VARIABLES_LOCAL_EQUALS: '=',
                LANG_VARIABLES_LOCAL_TOOLTIP: 'Declara e define uma vari�vel LOCAL do tipo inteiro (int) ou texto (String).',
                LANG_VARIABLES_DEFINE: 'Definir vari�vel ',
                LANG_VARIABLES_DEFINE_AS: 'como',
                LANG_VARIABLES_DEFINE_TOOLTIP: 'Definir o valor de uma vari�vel.',
                LANG_VARIABLES_SET: 'Var',
                LANG_VARIABLES_SET_AS: '=',
                LANG_VARIABLES_SET_TOOLTIP: 'Troca o valor de uma vari�vel.',
                LANG_VARIABLES_GET: 'Var',
                LANG_VARIABLES_GET_TOOLTIP: 'Devolve o valor de uma vari�vel',
                LANG_VARIABLES_PIN_ANALOG: 'Pino anal�gico',
                LANG_VARIABLES_PIN_DIGITAL: 'Pino digital',
                LANG_VARIABLES_PIN_DIGITAL0: 'AVISO: o pin digital 0 (pin RX) � utilizado ao carregar um esbo�o. Utiliz�-lo para ligar componentes eletr�nicos pode causar problemas ao carregar um novo esbo�o.',
                LANG_VARIABLES_PIN_TOOLTIP: 'Seleciona o pino desejado.',
                //zum blocks :
                LANG_CATEGORY_ZUM: 'Zum bloqs',
                LANG_ZUM_BUTTON: 'Bot�o',
                LANG_ZUM_BUTTON_PIN: 'PIN#',
                LANG_ZUM_BUTTON_TOOLTIP: 'Bot�o zum',
                ...
                LANG_ZUM_PHOTORESISTOR: 'Sensor de Luz',
                LANG_ZUM_PHOTORESISTOR_PIN: 'PIN#',
                LANG_ZUM_PHOTORESISTOR_TOOLTIP: 'Devolve o valor anal�gico do sensor de luz (foto-resist�ncia).',
                ...
                LANG_ZUM_PIEZO_BUZZER_LA: 'LA',
                LANG_ZUM_PIEZO_BUZZER_SI: 'SI',
                LANG_ZUM_PIEZO_BUZZER_DURATION: 'Dura��o',
                LANG_ZUM_PIEZO_BUZZER_TOOLTIP: 'Cigarra',
                LANG_ZUM_PIEZO_BUZZERAV: 'Cigarra avan�ado',
                LANG_ZUM_PIEZO_BUZZERAV_PIN: 'PIN#',
                LANG_ZUM_PIEZO_BUZZERAV_TONE: 'TOM',
                LANG_ZUM_PIEZO_BUZZERAV_DURATION: 'Dura��o',
                LANG_ZUM_PIEZO_BUZZERAV_TOOLTIP: 'Cigarra - Elemento piezoel�trico avan�ado.',
                LANG_ZUM_POTENTIOMETER: 'Potenci�metro',
                LANG_ZUM_POTENTIOMETER_PIN: 'PIN#',
                LANG_ZUM_POTENTIOMETER_TOOLTIP: 'Potenci�metro zum.',
                //servo blocks :
                LANG_CATEGORY_SERVO: 'Servo',
                LANG_SERVO_CONT: 'Servo de rota��o cont�nua',
                LANG_SERVO_CONT_PIN: 'PIN#',
                LANG_SERVO_CONT_ROT: 'ROT',
                LANG_SERVO_CONT_TURN_CLOCKWISE: 'GIRAR no SENTIDO HOR�RIO',
                LANG_SERVO_CONT_TURN_COUNTERCLOCKWISE: 'GIRAR no SENTIDO ANTI-HOR�RIO',
                LANG_SERVO_CONT_STOPPED: 'PARAR',
                LANG_SERVO_CONT_DELAY: 'Pausa',
                LANG_SERVO_CONT_TOOLTIP: 'Servo de rota��o cont�nua.',
                LANG_SERVO_MOVE: 'Servo',
                LANG_SERVO_MOVE_PIN: 'PIN#',
                LANG_SERVO_MOVE_DEGREES: 'Graus (0~180)',
                LANG_SERVO_MOVE_DELAY: 'Pausa',
                LANG_SERVO_MOVE_TOOLTIP: 'Mover o servo entre 0 e 180 graus.',
                LANG_SERVO_WARNING: 'N�o � poss�vel definir o pin servo utilizando uma vari�vel.'
            };
            // Node
            if (typeof module !== 'undefined' && module.exports) {
                module.exports = language;
